...
setwd("/diskmnt/Projects/Users/miglesia/PAM50/code")

paramDir<- "." # the location of unchanging files such as the function library and main program
inputDir<- "/diskmnt/Projects/Users/miglesia/PAM50/example_files"  # the location of the data matrix, and where output will be located
